...
public class FeedbackDaoIMPL extends HibernateDaoSupport implements FeedbackDao {
	...
	public List<CstService> findCstServices(int curPage, int pageSize,ServiceForm serviceForm) {
		...
		stringBuffer.append("from CstService where svrStatus='已处理'");
		/*
		 * 客户名称
		 */
	...
	public int getMaxPage(int curPage, int pageSize, ServiceForm serviceForm) {
		...
		stringBuffer.append("select ceiling(COUNT(*)*1.0/" + pageSize
				+ ") from CstService where svrStatus='已处理'");
		/*
		 * 客户名称
		 */
		if (serviceForm.getCusName() != null
	...
	public int getCount() {
		// TODO Auto-generated method stub
		String sql="select COUNT(*) from CstService  where svrStatus='已处理'";
	...
	public int getSize(ServiceForm serviceForm) {
		// TODO Auto-generated method stub
		StringBuffer stringBuffer = new StringBuffer();
		stringBuffer.append("select ceiling(COUNT(*)*1.0) from CstService  where svrStatus='已处理'");
		/*
		 * 客户名称
		 */
		if (serviceForm.getCusName() != null
